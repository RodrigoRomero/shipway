...
class Caballo_mod extends RR_Model {
    ...
    public function getListado(){        
        ...
        $dg = array("datagrid" => $datagrid,
                    "grid_type" => "jData-table j-caballos_list",                   
                    "filters"  => $filter);
                    ...
                    switch($categoria->id){
                        ...
                        case 2:
                            $values_transferencias = array('caballo_id'           => $id,
                                                           ...
                                                           'preneces_solicitadas' => $this->input->post('preneces_solicitadas',true));
        ...
        switch ($this->categoria_id){
            case 1:
                $query = "SELECT c.*, f.total_saltos
                          FROM caballos c
                          LEFT JOIN (SELECT caballo_id, COUNT(id) total_saltos FROM fichas WHERE temporada_id = ".$temporada->id." AND activo = 1 GROUP BY caballo_id) f ON f.caballo_id = c.id
