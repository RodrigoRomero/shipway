...
//echo control_group('Imágenes', upload_manager("",array("id"=>$row->id, "pos"=>'0', "uploadFolder"=>"uploads/caballos/", "filter"=>$img_caballo->filter, "resize"=>$img_caballo->resize, "ratio"=>$img_caballo->ratio)),$attr = array());
